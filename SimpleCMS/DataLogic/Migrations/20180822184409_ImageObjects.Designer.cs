...
namespace DataLogic.Migrations
{
    ...
    [Migration("20180822184409_ImageObjects")]
    partial class ImageObjects
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DataDomain.DbEntities.ImageObject", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("DataDomain.DbEntities.ImageObject", b =>
                {
                    b.HasOne("DataDomain.DbEntities.User", "UploadedBy")
                        .WithMany()
